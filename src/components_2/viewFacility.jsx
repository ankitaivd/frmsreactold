...
// alert(calendernfo.month);
// alert(calendernfo.currentYear );
...
<div class="col-md-8">
                ...
                <div class="detail-page-header">					
                    ...
                    <div class="row" style={{marginTop:'20px'}}>
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style={{fontFamily: 'Heebo-Bold', textAlign: 'left', color: '#212529', fontSize: '17px'}}>Amenities:</div>
                    ...
                    <div class="row">    
                         ...
                         <div class="col-xs-3 col-sm-3 col-md-3 col-lg-3" style={{fontFamily: 'Heebo-Bold', textAlign: 'left',  color: '#212529', fontSize: '17px'}}>Rates:</div>   

                          <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 text-left content-para" style={{color:'#212529'}}>From $15.00 per hour.  Additional fees may apply for services, utilities, etc.</div>  
...
<p style={{fontSize: '14px',marginBottom: '0px',fontFamily: 'Heebo-Medium'}}>Start Time</p>
                ...
                <span onClick={() => setShowTime1()} style={{color: '#506172', fontSize: '14px'}}>{time}</span>
...
<span onClick={() => setEndShowTime1()} style={{color:'#506172', fontSize: '14px'}}>{endtime}</span>
</div>
