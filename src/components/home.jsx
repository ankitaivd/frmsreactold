...
//   const location = useLocation();
  ...
  const [paginationfac,setPaginationfac] = useState({perPage:100,totalCount:0,totalPage:1,currentPage:1});
...
window.addEventListener('load', (event) => {
  ...
  try {
    ...
    useEffect(() => {
      ...
      Axios.post("locationList",{perpage:100,page:1})
      .then(res =>{
        console.log("request");
    ...
    const getLocationFacility=(data)=>{
      ...
      // setLocation(data.id);
       ...
       Axios.post("getLocationFacility",{facilityid:data.id,perpage:100,page:1})
        .then(res =>{
          console.log("request");
          console.log(res.data.response);
