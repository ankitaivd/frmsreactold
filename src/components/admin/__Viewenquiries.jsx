...
const Viewenquiries = () => {
  ...
  useEffect(() => {
  Axios.post("getMyProfile",{id:0,status:'submit'})
.then(res =>{
  console.log("Get Data");
  console.log(res.data);
  setAllBookings(res.data.totaldetailsbook);
       ...
       <div data-label="Example" class="df-example demo-table">
             ...
             <table class="table table-bordered mg-b-0 text-center">
               <thead>
                 <tr class="heading-sec-table">
                   ...
                   <th scope="col" style={{width:'460px'}}>Organization</th>
          ...
          <tr>
                  ...
                  <td>{post.timediffen}</td>
                   <td>
                   <Link to={`/Viewdetails/${post.details.bid}`}>
