...
calrea=cancelres.cancelreason;
  ...
  Axios.post("adminApproved",{initiate:initiate,id:id,canrea:calrea,loc_ad_id:applicant_id1})
.then(res =>{
...
<> 
      ...
      {a3.applicant_info.type==='admin' &&
           <div class="next-sec" >{detailsApplicant.status==='submit' ?  <> <span type="button" class="btn  btn-add btn-green btnNext" onClick={()=>setShow3(true)} style={{width:'20%'}}>Send to Location Admin</span>
           <button type="button" onClick={()=>setInitiate({status:'Approved',message:'You are about to approve this request',active:true})} data-toggle="modal" class="btn  btn-add btn-greennew btnNext">Approve</button>
         ...
         <Link    to={`/Viewrequest`} id="printpagebuttonlink"  style={{backgroundColor: '#fa8b01', width:'120px', height: '40px', lineHeight: '40px', color: '#fff', fontSize: '16px', cursor:'pointer',
...
{a3.applicant_info.type==='globaladmin' &&
    ...
    <div class="content content-fixed-new" id="deatilsnewforprintnew"  style={{maxWidth:'1120px',margin:'0 auto', display:'none', paddingTop:'0px'}}>
    
    <div class="col-md-12 officer-detail-sec" style={{paddingLeft: '0px', paddingRight:'0px', paddingTop:'0px'}}>
      <div class="">
...
<Modal show={initiate.active} onHide={handleCloseM}>
