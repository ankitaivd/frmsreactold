...
const submit =()=>{
  ...
  Axios.post("adminComaplete",{initiate:initiate,id:id,canrea:cancelres.cancelreason})
.then(res =>{
...
<> 
      ...
      {(a3!='' && a3.applicant_info.type==='admin') && <>

      <div class="next-sec" >
      {detailsApplicant.status==='approved' ?
      <button type="button" onClick={()=>setInitiate({status:'Approved',message:'Your are about to Complete this request',active:true})} data-toggle="modal" class="btn  btn-add btn-green btnNext">Complete</button>
      :''}
...
{(a3.applicant_info!='' && a3.applicant_info.type==='globaladmin') &&
         <div class="next-sec" >
