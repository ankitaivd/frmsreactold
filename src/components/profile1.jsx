...
Axios.post("submitMyBooking",{event:event,id:eventBooking.bid,applicant_id:eventBooking.applicant_id})
.then(res =>{
  console.log("request");
  console.log(res.data);
                          ...
                          <div class="row" style={{marginTop:'30px'}}>
                            ...
                            <div class="col-md-9 form-sec-profile"><input type="text" value={login.address2} name="address2" onChange={inputEvent} /></div>
                                ...
                                <div class="row" style={{marginTop:'30px'}}>
                                  ...
                                  <div class="col-md-3"><p class="label-profile">Address Line2<span style={{color:'red',position:'relative'}}>*</span></p></div>
...
<div class="add-more-sec"onClick={addOffice}>
                    <a  class="btn btn-adds">ADD MORE<i class="fa fa-plus" style={{marginLeft:'6px',color:'#ffffff !important'}} aria-hidden="true"></i>
                    </a>
                  </div>
      ...
      {   bookings.map((post,index)=>(   
       <div class="row booking-border">        
            ...
            <div class="col-md-12" style={{paddingLeft: '7px'}}>
              ...
              <h2 style={{color:`#FA8B01`}}>
                {post.status==='draft' ? "Draft ":"Pending "} 
                {/* {post.status==='submit' ? "Pending":""} 
            ...
            <a onClick={()=>setShow4(true)} class="btn-cacl-book btn-cancelss" style={{textDecoration: 'none',marginRight:'15px'}} > Cancel Booking</a>
            { reducer3.applicant_info.profile_status==="Complete" ?
           <a onClick={()=>[setShow2('true'),getFacilitiesofLocation(post),setEventBooking(post)]}  class="btn-cacl-book" style={{textDecoration: 'none'}} data-toggle="modal" data-target="#exampleModalcancel" data-dismiss="modal"> Complete Booking</a>
              :<a onClick={()=>[setShow3('true')]}  class="btn-cacl-book" style={{textDecoration: 'none'}} data-toggle="modal" data-target="#exampleModalcancel" data-dismiss="modal"> Complete Booking</a>
            }
            </div> :''}        
...
<p style={{marginBottom: '0px',fontSize: '15px',lineHeight: '24px', width: '95%', margin:'0 auto', textAlign: 'center'}}>Profile Updated .... </p>

<button class="btn-process btn-confirm btn-save" style={{float:'initial',marginTop:'15px',fontSize:'13px',padding:'8px 3px',marginBottom:'35px'}} onClick={()=>[setShow1(false),activeTab('booking')]}>Complete Booking</button>
...
<Modal show={show2} onHide={handleClose2} >
  <div class="bookingclose" style={{backgroundColor: '#ffffff', width: '620px', marginTop: '50px'}}>
        ...
        <div class="modal-body modal-body-apply modal-request modal-padding" style={{padding:'22px 0px',height:'430px',overflowY:'scroll',textAlign:'justify'}}>
          <div class="row">
       ...
       Event Name: <input type="text"  name="eventname" value={setEvent.eventname}  onChange={inputEventDetails} style={{outline:'none', height:'32px',marginLeft:'10px',fontWeight:'400',border:'1px solid #cccccc',width:'73%',marginLeft:'61px'}}/>
       </div>
      
      
       <div class="col-md-12" style={{color:'#506172'}}>
       Number of Participant: <input type="text"  name="eventparticipant" value={setEvent.eventname}  onChange={inputEventDetails} style={{marginTop:'15px', outline:'none', height:'32px',fontWeight:'400',border:'1px solid #cccccc',width:'73.0%'}}/>
       </div>
       {/* <div class="col-md-4">
         Participant:<input type="text"  name="noOfGuest" value={setEvent.noOfGuest}  onChange={inputEventDetails} style={{outline:'none', fontWeight:'400'}}/>
       </div> */}
       ...
       <textarea  name="eventDetails" onChange={inputEventDetails} style={{marginTop:'20px',height:'95px',outline:'none',fontWeight:'400',border:'1px solid rgb(204, 204, 204)',width:'73%'}}></textarea>
         </div>
        <div class="row col-md-12" style={{marginTop:'18px'}} >
                <div class="col-md-6">
                  <span style={{color:'rgb(80, 97, 114)'}}>Date:</span><input type="date" name="eventname"  style={{marginLeft:'10px',color:'rgb(80, 97, 114)',height:'33px',outline: 'none', fontWeight: '400', border: '1px solid rgb(204, 204, 204)', width: '80%', marginleft: '61px'}} />
...
<p>Time:-</p><span onClick={() => setShowTime1()}>12:00:AM</span> - <span onClick={()=>setEndShowTime1()}>12:00:AM</span>
        </div>
        </div>
        <div class="col-md-12">
...
<input  type="checkbox" onClick={changeAmenities} id={childpost.amenities_id}  class="checkboxField checkboxField-new" defaultChecked={childpost.booked===1} />
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px'}}>
                  ...
                  <input type="text" value={login.organization} onClick={changeAmenities} name="applicantorganization"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                  </div>
         </div>
         ...
         <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  value={login.position}  onClick={changeAmenities} name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  value={login.address1}   name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>  
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  name="eventname"  value={login.address2}  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  name="eventname"  value={login.address3}  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  value={login.city}   name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text" value={login.state}    name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text" value={login.phone}    name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text" value={login.name}   name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text" value={login.detailOrganization}  name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'15px'}}>
                   ...
                   <div class="col-md-7 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  name="eventname" value={login.objectiveOrganization}  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px'}}/>
                   </div>
          </div>
          ...
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'12px'}}>
                   ...
                   <input type="text" value={login.memberOfOrganization}  name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px',width:'50%'}}/>
                   </div>
          </div>
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'12px'}}>
                   ...
                   <div class="col-md-4 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text" value={login.memberAverageAge}  name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px',width:'50%'}}/>
                   </div>
          </div>
          <div class="row col-md-12" style={{color:'#506172',paddingRight:'0px',marginTop:'12px'}}>
                   ...
                   <div class="col-md-4 form-sec-profile" style={{paddingRight:'0px'}}>
                   <input type="text"  value={login.premises}  name="eventname"  style={{outline:'none', fontWeight:'400',border:'1px solid #cccccc',padding:'7px 8px',height:'31px',width:'50%'}}/>
                   </div>
          </div>
